...
import { getNewsController, getNewsByIdController, getNewsByTitleController, postNewsController, deleteNewsController, changeNewsController } from "../../controllers/news";
